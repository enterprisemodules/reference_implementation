...
)
{
  ...
  wls_server{'soa/AdminServer':
    ...
    arguments                   => $profile::wls::admin_server_arguments,
    listenaddress               => $profile::wls::adminserver_address,
    listenport                  => $profile::wls::adminserver_port,
    machine                     => 'LocalMachine',
    logfilename                 => "${profile::wls::wls_log_dir}/AdminServer/AdminServer_${domain_name}.log",
    log_datasource_filename     => "${profile::wls::wls_log_dir}/AdminServer/datasource.log",
    log_http_filename           => "${profile::wls::wls_log_dir}/AdminServer/access.log",
  ...
  wls_install::packdomain{$domain_name:
    ...
    wls_domains_dir     => $profile::wls::domains_dir,
    domain_name         => $profile::wls::domain_name,
    os_user             => $profile::wls::os_user,
